% Demonstrates the usage of the SimpleFreeFieldHRSOS conventions.
...
clear;
conventions='SimpleFreeFieldHRSOS';
...
%% save the SOFA file
SOFAfn=fullfile(SOFAdbPath,'sofa_api_mo_test',[conventions '.sofa']);
disp(['Saving:  ' SOFAfn]);

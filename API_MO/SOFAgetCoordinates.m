function output = SOFAgetCoordinates(input,input_type,output_type,input_unit,output_unit)
%SOFAgetCoordinates
%   output = SOFAgetCoordinates(input,input_type,output_type,input_unit,
%   output_unit), converts the specified coordinate varable to specified

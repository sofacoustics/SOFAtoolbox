...
% 				 'GLOBAL_Version' SOFAgetVersion('SOFA') 'rma' ''; ... will be mandatory in SOFA 0.3
         'GLOBAL_SOFAConventions' 'SimpleFreeFieldHRIR' 'rma'  ''; ... % this is an inconsistency with SOFA 0.2, but is actually correct and will be fixed in SOFA 0.3
         'GLOBAL_SOFAConventionVersion' '0.0.2' 'rma'  ''; ...
%          'GLOBAL_SOFAConventionsVersion' '0.0.2' 'rma'  ''; ... will be fixed in SOFA 0.3
  ...
  case 'SingleRoomDRIR'      
        ...
        metadataarray={ ...
         'GLOBAL_Conventions' 'SOFA' 'rma'  ''; ...
% 				 'GLOBAL_Version' SOFAgetVersion('SOFA') 'rma' ''; ... will be mandatory in SOFA 0.3
         'GLOBAL_SOFAConventions' 'SingleRoomDRIR' 'rma'  ''; ... % this is an inconsistency with SOFA 0.2, but is actually correct and will be fixed in SOFA 0.3

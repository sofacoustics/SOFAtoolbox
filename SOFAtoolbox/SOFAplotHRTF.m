...
%     'ITDhorizontal'  Interaural time delays (ITDs) in the horizontal plane
%
...
% #Author: Michael Mihocic: bug fix if Obj.SourcePosition = 1 (27.06.2025)
% #Author: Michael Mihocic: fixes for case 'itdhorizontal': 1) compensate Obj.Data.Delay; 2) Octave support implemented (27.10.2025)
%
...
switch lower(type)
    ...
    case 'itdhorizontal'
        ...
        if exist('OCTAVE_VERSION','builtin') % is Octave?

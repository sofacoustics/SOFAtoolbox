function ObjNew=SOFAconvertMultiSpeakerBRIR2SingleRoomMIMOSRIR(Obj)
%SOFAconvertMultiSpeakerBRIR2SingleRoomMIMOSRIR - converts SOFA objects from SOFAconvertMultiSpeakerBRIR to SingleRoomMIMOSRIR convention
%   Usage: Obj=SOFAconvertMultiSpeakerBRIR2SingleRoomMIMOSRIR(Obj)
% 
%   SOFAconvertSOFA2ARI(Obj) converts and upgrades a SOFA object from deprecated SOFAconvertMultiSpeakerBRIR convention to recommended, standardized SingleRoomMIMOSRIR convention. 
%     The script was created based on the existing data so far. Deprecated conventions data should not be created anymore.
%
%   Input parameters:
%     Obj : SOFA object (SOFA format) in SOFAconvertMultiSpeakerBRIR convention
% 
%   Output parameters:
%     Obj : SOFA object (SOFA format) in SingleRoomMIMOSRIR convention

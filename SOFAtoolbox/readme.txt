This is a readme file for the SOFA Toolbox for Matlab and Octave.

* When adding SOFA Toolbox to Matlab search path: Use "Add Folder" (don't use "Add with Subfolders"!)
...
* Report a bug: send a ticket at https://github.com/sofacoustics/API_MO/issues.
* Last changes? check the file "history.txt".

Tested with Matlab R2016a (and higher) and Octave 4.2.1.
